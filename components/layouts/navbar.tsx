...
const Navbar: React.FC = () => {
  ...
  const routes = [
    ...
    { name: "Products", link: "/productsListing" },
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between lg:w-[40%]">
          ...
          <div className="relative pr-2 pt-2 block md:hidden">
            <Link href="/carts" className="no-underline hover:underline">
              ...
              >
                <path
                  ...
                  fill={` ${
                    router.pathname.startsWith("/carts") ? "#D95F27" : "#929292"
                  }`}
                />
              </svg>
            </Link>
            ...
            {cart.length > 0 && (
              <span className="absolute top-[0] right-[0.1em] text-orange-primary text-xs ">
                {cart.length}
              </span>
            )}
          </div>
        ...
        <div
          className={`links h-0 overflow-hidden transition-all md:flex md:h-auto bg-white-bg  md:bg-transparent absolute top-[4em] left-0 md:relative md:top-0 md:left-0 md:border-none  md:rounded-none ease-in-out z-50 nav__div flex flex-col md:flex-row md:gap-6  px-5 py-8  md:mx-0 md:p-0
        ${
          open
            ? "h-[100vh] md:w-fit w-[60%] left-0"
        ...
        >
          <ul className="flex md:flex-row md:gap-6 font-medium gap-[1.4em] justify-end md:justify-normal md:items-center items-end flex-col  md:border-none list-none pb-[1em] md:pb-0 lg:W-[60%]">
            ...
            <div className="relative pr-2 pt-2 hidden md:flex">
              <Link href="/carts" className="no-underline hover:underline">
                <svg
                  width="24"
                  height="24"
