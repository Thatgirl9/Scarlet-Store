    ...
    >
      ...
      >
        ...
        >
              ...
              <Link href="/carts" className="no-underline hover:underline">
                ...
                >
                  <path
                    ...
                    fill={` ${
                      router.pathname === "/carts" || "/carts/checkout"
                        ? "#D95F27"
                        : "#929292"
                    }`}
                  />
          ...
          {/* <div className=" hidden gap-[1.2em] md:gap-4 justify-end items-end md:justify-normal md:items-center">
            <div>
              <Image
                src={DesktopIcon}
                alt="A Desktop Icon"
        ...
        {/* <div className="hidden  flex-col gap-[1.2em] md:gap-4 justify-end items-end md:justify-normal md:items-center">
          <div>
            <Image
              src={DesktopIcon}
              alt="A Desktop Icon"
